...
- **播放控制**：鼠标悬浮歌词区时叠加显示「上一首 / 播放暂停 / 下一首」，控制当前已识别的播放器
- **音频频谱**：跟随当前播放器（QQ音乐/网易云音乐，其他软件出声不受影响）播放跳动的圆角柱频谱，可在右键菜单手动开启/关闭；频谱颜色跟随已播放歌词颜色，开启时窗口自动加宽、关闭即恢复
...
2. 右键托盘图标：
   ...
   - **显示平台图标**：在专辑封面右下角显示或隐藏当前播放器平台图标
   - **专辑封面效果**：选择「默认」或「黑胶唱片」效果；黑胶效果在播放时旋转，暂停时保持当前位置
   - **频谱**：开启/关闭音频频谱
   - **字体…** / **字体颜色与效果…**：外观自定义
   - **已播放颜色跟随专辑**：提取当前专辑封面主色调作为已播放（高亮）颜色（关闭后恢复手动配置的颜色）
   - **手动搜索歌词**：自动匹配不准时手动选词，支持手动提前或者延迟0.5秒并持久化
   - **双行歌词**：当前歌曲没有可用翻译或罗马音时，显示当前歌词和下一行预览
